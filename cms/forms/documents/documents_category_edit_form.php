<script>
    jQuery(document).ready(function () {
        ...
        jQuery('body #menu_content')
                ...
                .find('ul')
                .css('display', 'block')
                .find('#menu_contents_documents_categories')
                .addClass('active');
    });
</script>
...
$features = get_select_html_plus_data(
        'documents_category_features', // таблица МОДУЛЬ_features
        'id', //$field_value
        'title', //$field_text
        'value', //$select_type
        '1', //$select
        'documents_category_features_prefix', // таблица МОДУЛЬ_features_prefix
        array(// Таблица 
    'id',
    'title',
    'default_value', // data-
...
$exit_link = 'admin.php?link=documents_categories';
...
$this_module_images_path = '/images/documents_images/categories_images/';
