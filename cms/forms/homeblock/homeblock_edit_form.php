...
//    'value', //$select_type
//    '1', //$select
//    'homeblocks_features_prefix', // таблица МОДУЛЬ_features_prefix
//    array(// Таблица
//        'id',
//        'title',
//        'default_value', // data-
...
$this_module_images_path = '/images/homeblocks_images/homeblocks/';
// Параментры изображений (Вместо чисел Берутся переменные из configuration.php )
$this_module_big_img_width = 600;
$this_module_big_img_height = 600;
$this_module_small_img_width = 500;
$this_module_small_img_height = 500;
                                ...
                                <div class="tab-content no-space">
                                    <div class="tab-pane active" id="tab_general">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-1 control-label">Описание:<span
