...
$features = get_select_html_plus_data(
        'photogallary_features', // таблица МОДУЛЬ_features
        'id', //$field_value
        'title', //$field_text
        'value', //$select_type
        '1', //$select
        'photogallary_features_prefix', // таблица МОДУЛЬ_features_prefix
        array(// Таблица 
    'id',
    'title',
    'default_value', // data-
...
$exit_link = 'admin.php?link=photogallary';
...
$catalog_categories_json_data = get_categories_json_data(
        'photogallary_category', //Таблица категорий модуля
...
$this_module_images_path = '/images/photogallary_images/photogallary/';
// Параментры изображений (Вместо чисел Берутся переменные из configuration.php )
$this_module_big_img_width = 1200;
$this_module_big_img_height = 1200;
