...
<div class="page-content-wrapper">
    <div class="page-content">
        ...
        <div id="modal_menu_module2" class="modal  fade" tabindex="10" role="dialog" aria-labelledby="myModalLabel1"
             aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button class="btn default cancel_set_menu_link" data-dismiss="modal" aria-hidden="true">
                            Отменить
                        </button>
                    </div>
                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="input-group input-append bootstrap-timepicker-component">
                                                        <input class="form-control m-wrap m-ctrl-small timepicker-24"
                                                               readonly
                                                               type="text"
                                                               data-massive-element-type="input"
                                                               id="oq_time_question"
