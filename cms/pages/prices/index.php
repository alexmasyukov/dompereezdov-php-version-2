<script>
    ...
    view_module('module_prices_table_json', 3000, '<?php echo $filter;?>'); // Универсальная
</script>
...
$module_info = array(
    link => 'price_edit_form', // Форма редактирования
    id => '',
    sql_table => 'prices',
    ...
    page_title => 'Таблицы прайсов',
    module_title => '',
    where_you_title_1 => 'Прайсы',
    where_you_link_1 => 'admin.php?link=prices',
    where_you_title_2 => '',
    where_you_link_2 => ''
);
