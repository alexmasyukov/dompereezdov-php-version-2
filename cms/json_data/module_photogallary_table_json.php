	...
	$param_json = '
		{
			"mysql_filelds":{
				...
				"f7":{
					...
					"object": "value",
					"sql_table": "photogallary_category",
					"sql_id_column": "id",
			...
			"mt": "photogallary",
                        "sql_images_table_name": "photogallary_images",
			"sql_images_table_id_title": "module_item_id",
			"sql_features_table_name": "photogallary_features_values",
			"sql_features_table_id_title": "module_item_id",
                        "go_link": "admin.php?link=photogallary",
			"limit_string": 25,
			"nl2br": "yes",
