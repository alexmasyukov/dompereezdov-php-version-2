...
// todo Импорт дополнительных переменных в pages из Google таблицы
// todo Восстановить исходную таблицу pages и упростить по ШАГУ ЧИСТОТА
// todo Импорт новых городов из гугл таблиц из Москвы в Б
//       там где нет совпадений по данным из pages сделать склонения
//       (уточнить у Влада с типом или нет)
// (13 ч + )
